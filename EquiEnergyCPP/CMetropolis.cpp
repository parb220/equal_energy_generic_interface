...
void CMetropolis::BlockAdaptive(const CSampleIDWeight &adaptive_start_point, const vector<TDenseMatrix> &B, double mid, int period, int max_period, bool if_eejump)
...
{
	int k = (int)B.size(); 	// number of blocks
	...
	vector<int> b(k,0); // b(i): size of the i-th block
	for (int i=0; i<k; i++)
		b[i] = B[i].cols;  
...
{
	int k=(int)blocks.size(); 	// number of blocks	
...
bool CMetropolis::AdaptiveBeforeSimulation_OnePass(const CSampleIDWeight &adaptive_start_point, int period, int max_period, const string &block_file_name, bool if_eejump, const string &block_scheme_file_name)
...
bool CMetropolis::AdaptiveAfterSimulation_WeightedSampling_OnePass(const CSampleIDWeight &adaptive_start_point, int period, int max_period, std::vector<TDenseMatrix> &B_matrix, const string &block_file_name, bool if_eejump)
{
	CSampleIDWeight x=adaptive_start_point; 
